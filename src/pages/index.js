    ...
    <LayoutContainer>
      <div className={`bg-${theme.light.white || theme.dark.orange}`}>
        <div className="container mx-auto">
          <div
            className={`relative flex flex-col-reverse lg:flex-row rounded-t-lg py-4 pl-8 lg:pl-23 bg-${theme
              .light.blueDarker || theme.dark.purpleDarkest}`}
          >
            <div className="absolute pin z-0 overflow-hidden">
              ...
              <div className="hidden lg:block absolute pin-r pin-b ml-32">
                <div className="mr-32 flex">
                  <svg
                    className={`h-48 w-48 -mr-32 z-10 fill-current text-${theme
                      .light.blueDarker || theme.dark.purpleDarkest}`}
                    css="opacity: 0.9"
                    viewBox="0 0 100 100"
                    xmlns="http://www.w3.org/2000/svg"
      ...
      <div className="container mx-auto">
        <div
          ...
          css={theme.light.indexGradient || theme.dark.indexGradient}
        >
