---
title: Contribute
description: "The xi-editor project is committed to fostering and preserving a
diverse, welcoming community; all participants are welcome to participate to the project"
---
...
- **_Be your own first reviewer_**. On the page where you enter your message,
